...
export type MoviesDataContextOptions = FactoryDataContextOptions<IRawMoviesData>

export class MoviesDataContext extends DataContext<
    IRawMoviesData
> {
    /**
     * Constructor
     */
    public constructor(options: MoviesDataContextOptions) {
        super(options);
    }
