...
export type GelbooruDataContextOptions = FactoryDataContextOptions<IRawGelbooruData>

export class GelbooruDataContext extends DataContext<
    IRawGelbooruData
> {
    /**
     * Constructor
     */
    public constructor(options: GelbooruDataContextOptions) {
        super(options);
    }
    ...
    public get id(): number {
        return this.payload.gelbooru_id;
    }
